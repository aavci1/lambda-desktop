...
- Media: SVC-12 (MPRIS). Basic client/status/control plumbing exists, the dock can show now-playing with capability-gated play/pause/skip actions, and player changes refresh through the D-Bus event pump; richer now-playing UI and media-key routing remain.
