...
- Complete the active Window Manager TODO items tracked in `TODO.md`: TODO-006 close animation as one whole-window snapshot path, TODO-007 minimized window state and Shell dock-preview handoff, TODO-008 live resize frame coherence, TODO-011 stable Super+Tab cycling, and TODO-015 visual Super+Tab overlay.
