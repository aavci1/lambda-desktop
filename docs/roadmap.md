...
| [frame-pacing-improvement-plan.md](frame-pacing-improvement-plan.md) | Verification follow-up checklist and Linux verifier entry point for the completed compositor/graphics frame-pacing implementation (TODO-019) |
