...
| Shell | App registry, dock, IPC, config, icons, status fallback, and a basic live notification banner exist; notification center/actions, clipboard, tray, and most provider control remain, gated on System Services. |
