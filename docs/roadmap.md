...
| [vulkan-improvement-plan.md](vulkan-improvement-plan.md) | Active Vulkan/Linux graphics backlog: sync, error reporting, platform-interface cleanup, canvas modularization, Metal parity |
