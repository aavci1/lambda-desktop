...
| P3 | WM-COMP-4 Scene and output damage architecture | In progress | Conservative scene-damage foundation is verified; next step is making frame scheduling consume damage safely | Snapshot/damage tests plus render scheduler tests | DP-1 resize trace, real-app flicker check, video/browser pacing |
