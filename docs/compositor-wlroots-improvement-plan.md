...
13. Planned: define any remaining cancellation rules for destroyed focus surfaces, popup parents, and keyboard grabs outside the Firefox menu path.
14. Planned: add broader automated tests for keyboard grab start/end/cancel and popup/menu focus workflows that require live Wayland resources.
15. Planned: request manual app menu/dock menu validation if runtime grab behavior changes again.
