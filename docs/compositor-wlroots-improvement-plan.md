...
7. Planned: define any remaining cancellation rules for destroyed focus surfaces, popup parents, layer-shell focus surfaces, and non-popup pointer/keyboard grabs outside the Firefox menu path.
8. Planned: add broader automated tests for grab start/end/cancel, destroyed-surface cleanup, popup/menu focus, and keyboard focus restoration.
9. Planned: request manual app menu/dock menu validation if runtime grab behavior changes again.
