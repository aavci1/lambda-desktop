...
| P7 | WM-COMP-8 XDG surface role and configure lifecycle | Verified slice | Added wlroots-style `get_xdg_surface` base-role assignment and existing-buffer rejection | XDG surface lifecycle, xdg popup, layer role, compositor suite, and broader feasible suite pass | No manual gate needed for this protocol-lifecycle slice |
