...
9. Planned: define any remaining cancellation rules for destroyed focus surfaces, popup parents, and keyboard grabs outside the Firefox menu path.
10. Planned: add broader automated tests for keyboard grab start/end/cancel, popup/menu focus, and keyboard focus restoration.
11. Planned: request manual app menu/dock menu validation if runtime grab behavior changes again.
