...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/WaylandServerImpl.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Core.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/XdgShell.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/LayerShell.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/SubsurfaceState.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Snapshots.cpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/LayerShell.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/WaylandServerImpl.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/LayerShellState.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/LayerShellZones.cpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Core.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Snapshots.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Window/PointerRouter.cpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Snapshots.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/CompositorRenderFrame.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Surface/SurfaceRenderer.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/FrameScheduler.cpp`
- KMS presenter code under `lambda-desktop/apps/lambda-window-manager/Compositor/`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Seat.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Window/PointerRouter.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Window/FocusStack.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Selection.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/XdgShell.cpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/LinuxDmabuf.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Surface/SurfaceRenderer.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/CompositorRenderFrame.cpp`
- KMS presenter code under `lambda-desktop/apps/lambda-window-manager/Compositor/`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/XdgShell.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/WaylandServerImpl.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Window/WindowGeometry.cpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/XdgShell.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/WaylandServerImpl.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/XdgToplevelState.hpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Activation.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/ActivationState.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/WaylandServerImpl.hpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/PointerExtensions.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/PointerConstraintState.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/WaylandServerImpl.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Core.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Window/WindowManager.cpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Presentation.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/PresentationState.hpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/FractionalScale.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/FractionalScaleState.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/ServerLifecycle.cpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/IdleInhibit.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/IdleInhibitState.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/FrameScheduler.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Destroy.cpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Output.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/OutputState.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/ServerLifecycle.cpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/XdgOutput.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/XdgOutput.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/XdgOutputState.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Output.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/ServerLifecycle.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/WaylandServerImpl.hpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/PointerExtensions.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/PointerExtensions.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Seat.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/PointerExtensionState.hpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/CursorShape.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/CursorShape.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Seat.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/CursorShapeState.hpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Viewporter.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/ViewporterState.hpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Core.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Shm.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/XdgShell.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/LayerShell.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/Cutouts.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/BackgroundEffect.cpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/WaylandServerImpl.hpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Snapshots.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Chrome/`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Window/`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Window/PointerRouter.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Window/FocusStack.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Window/LayerShellInput.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Globals/XdgShell.cpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/LayerShellZones.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Window/LayerShellInput.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Window/FullscreenShellPanels.cpp`
- `tests/`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/Wayland/Snapshots.cpp`
- `lambda-desktop/apps/lambda-window-manager/Compositor/Window/`
- `lambda-desktop/apps/lambda-window-manager/Compositor/PresentationLoop.cpp`
...
- `lambda-desktop/apps/lambda-window-manager/Compositor/` trace hooks only where needed
- `tests/`
...
10. Verified slice: `scripts/run-real-app-smoke.sh --case` now rejects unknown selected case names at option-parse time, so a typo in a focused validation command cannot silently reduce the real-app matrix coverage.
11. Verified slice pending target-hardware run: after the repeated VT switch crash report, the atomic KMS presenter now clears stale pending page-flip/plane state at VT boundaries and forces a fresh modeset/present on resume; `scripts/verify-kms-vt-switch.sh` now defaults to two away/back cycles to reproduce the reported switch-away, switch-back, switch-away sequence.
...
| 2026-06-13 | WM-COMP-27 | Verified slice | Hardened focused real-app smoke selection by rejecting unknown `--case` names before probing or launching clients, preventing typoed validation commands from silently skipping intended matrix coverage. The matrix verifier now pins the selected-case validator and error path. `bash -n scripts/run-real-app-smoke.sh`, `bash -n scripts/verify-wm-comp27-matrix.sh`, `scripts/run-real-app-smoke.sh --no-build --case lambda-editor,not-a-case --probe-only` with the expected exit 2, `scripts/run-real-app-smoke.sh --no-build --case lambda-editor,lambda-terminal --probe-only`, `scripts/verify-wm-comp27-matrix.sh`, and `git diff --check` passed. |
| 2026-06-16 | WM-COMP-27 | Verified slice pending real-TTY run | Investigated `build/lambda-window-manager.log` after the repeated VT-switch crash report. The log ended after normal KMS startup with no fatal line and this session cannot access system coredumps, but the code path left `KmsAtomicPresenter::pageFlipPending_` and pending plane/buffer IDs intact across VT loss. `syncModeStateFromKernel()` now clears stale pending flips and active/pending scanout bookkeeping, invalidates scanout contents, and forces a fresh atomic modeset/present after reacquire. `scripts/verify-kms-vt-switch.sh` now defaults to two away/back cycles and checks the compositor process survives each away and return phase. `cmake --build build -j"$(nproc)" --target lambda-window-manager`, `bash -n scripts/verify-kms-vt-switch.sh`, `scripts/verify-kms-vt-switch.sh --help`, and `LWM_VT_SWITCH_TARGET=2 scripts/verify-kms-vt-switch.sh` with the expected non-TTY guard passed. Manual verification remains: run `LWM_VT_SWITCH_TARGET=<other-vt> scripts/verify-kms-vt-switch.sh` from a real TTY and repeat the interactive away/back/away sequence. |
