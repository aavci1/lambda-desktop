...
- [x] [Auto] Add and run multi-dirty partial-damage verification: latest run kept two decorated checker windows mapped while scripted multi-toplevel motion ran, observed 153 partial frames, 129 multi-rect partial frames, 631 flips with at least two surfaces, and kept surface avg/max at 0.175/0.431 ms under the verifier's 4.000 ms gate.
