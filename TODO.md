...
- [ ] [Auto + Manual] Wire UPower manager `PropertiesChanged`, `DeviceAdded`, and `DeviceRemoved` into Shell so AC state and battery device changes update without waiting for the polling timer.
